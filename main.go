...
import (
	...
	"math/rand"
	"github.com/Vladislavius12/Go_project/proto"
...
type srv struct{
	proto.UnimplementedReverseServer
	uuid.UUID
}

func (s *srv) Do(context.Context, *proto.Request) (*proto.Response, error) {
	s.UnimplementedReverseServer.Do()
